...
import 'package:pulse_pro/features/profile/view/widgets/outlog_slide.dart';
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          ProfileDetail(label: 'Age', value: calculateAge(state.pulseProUser!.birthDate).toString()),
                          const Spacer(),
                          ProfileDetail(
                              label: 'Gender', value: capitalize(state.pulseProUser!.gender.toString().split('.').last))
                        ],
                      ),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: [
                          ProfileDetail(label: 'Height', value: '${state.pulseProUser!.height} cm'),
                          const Spacer(),
                          ProfileDetail(label: 'Weight', value: '${state.pulseProUser!.weight} kg')
                        ],
                      ),
                      const SizedBox(
                        height: 10,
                      ...
                      GestureDetector(
                          ...
                          child: Text(
                            ...
                            style:
                                TextStyle(color: Colors.white.withOpacity(0.4), decoration: TextDecoration.underline),
                          )),
                      SizedBox(
